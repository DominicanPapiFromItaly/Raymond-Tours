// ===== DATA RAYMOND =====
let packages = [
  { id:1, title:"El Limón Waterfall + Las Terrenas (Punta Popi Beach)", dest:"Samaná, DR", desc:"Hike through the jungle to the famous waterfall and visit the most popular beach in Las Terrenas.", img:"assets/Limon.webp", badge:"Nature", slots:5 },
  { id:2, title:"Whale Watching + Cayo Levantado", dest:"Samaná Bay", desc:"Boat excursion to observe humpback whales and enjoy the iconic Bacardi Island.", img:"assets/Balena.webp", badge:"Seasonal", slots:5 },
  { id:3, title:"Cayo Levantado + Los Haitises National Park", dest:"Samaná, DR", desc:"Relax on Cayo Levantado and explore mangroves, caves, and unique wildlife in Los Haitises.", img:"assets/Cayo.webp", badge:"Island", slots:5 },
  { id:4, title:"Rincón Beach + Caño Frío", dest:"Samaná, DR", desc:"Discover one of the Caribbean’s most beautiful beaches and enjoy the refreshing Caño Frío river.", img:"assets/Rincon.jpg", badge:"Adventure", slots:5 },
  { id:5, title:"Frontón Beach + Las Galeras + Madama Beach + Rincón Beach", dest:"Samaná, DR", desc:"Complete tour of virgin and hidden beaches in the Las Galeras area.", img:"assets/Galeras.jpg", badge:"Exploration", slots:5 },
  { id:6, title:"Hermitanos Beach + El Valle Beach", dest:"Samaná, DR", desc:"Explore secret beaches surrounded by mountains and tropical vegetation.", img:"assets/Ermitano.jpg", badge:"Romantic", slots:5 },
  { id:7, title:"Buggy + ATVs (4-Wheel)", dest:"Samaná, DR", desc:"Extreme adventure through rural trails and hidden beaches by buggy and ATV.", img:"assets/Buggy.jpg", badge:"Adventure", slots:5 },
  { id:8, title:"Zipline in El Valle", dest:"Samaná, DR", desc:"Fly over valleys and rivers in a thrilling adrenaline-filled experience.", img:"assets/Zipline.webp", badge:"Unique", slots:5 }
];
