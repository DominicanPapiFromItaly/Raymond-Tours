// ===== DATA RAYMOND =====
let packages = [
  { id:1, title:"Salto de El Limón + Las Terrenas (Playa Punta Popi)", dest:"Samaná, RD", desc:"Caminata por la selva hasta la famosa cascada y visita a la playa más popular de Las Terrenas.", img:"assets/Limon.webp", badge:"Naturaleza", slots:5 },
  { id:2, title:"Avistamiento de Ballenas + Cayo Levantado", dest:"Bahía de Samaná", desc:"Excursión en barco para observar ballenas jorobadas y disfrutar de la icónica Isla Bacardí.", img:"assets/Balena.webp", badge:"Temporada", slots:5 },
  { id:3, title:"Cayo Levantado + Parque Nacional Los Haitises", dest:"Samaná, RD", desc:"Relájate en Cayo Levantado y explora manglares, cuevas y fauna única en Los Haitises.", img:"assets/Cayo.webp", badge:"Isla", slots:5 },
  { id:4, title:"Playa Rincón + Caño Frío", dest:"Samaná, RD", desc:"Descubre una de las playas más hermosas del Caribe y disfruta del río refrescante de Caño Frío.", img:"assets/Rincon.jpg", badge:"Aventura", slots:5 },
  { id:5, title:"Playa Frontón + Las Galeras + Playa Madama + Playa Rincón", dest:"Samaná, RD", desc:"Tour completo por playas vírgenes y escondidas de la zona de Las Galeras.", img:"assets/Galeras.jpg", badge:"Exploración", slots:5 },
  { id:6, title:"Playa Hermitanos + Playa El Valle", dest:"Samaná, RD", desc:"Explora playas secretas rodeadas de montañas y vegetación tropical.", img:"assets/Ermitano.jpg", badge:"Romántico", slots:5 },
  { id:7, title:"Buggy + Cuatrimotos (4 ruedas)", dest:"Samaná, RD", desc:"Aventura extrema recorriendo senderos rurales y playas escondidas en buggy y cuatrimoto.", img:"assets/Buggy.jpg", badge:"Aventura", slots:5 },
  { id:8, title:"Zipline en El Valle", dest:"Samaná, RD", desc:"Vuela sobre valles y ríos en una experiencia llena de adrenalina.", img:"assets/Zipline.webp", badge:"Único", slots:5 }
];
